...
const C = {
  ...
  bgCard:     "#F9F5EF",
  bgDeep:     "#F5F0E6",   // warm cream
  roseGold:   "#C9848A",   // primary accent — kept as-is
  roseLight:  "#E8B4BA",
  roseDark:   "#8C4A52",
  champagne:  "#C8A06A",
  champLight: "#A07040",
  lavender:   "#8A7A9A",
  lavLight:   "#6A5A7A",
  cream:      "#2D1B2E",   // dark plum — text primary
  muted:      "#6E5C62",   // charcoal rose — text secondary
  faint:      "#D8CCCC",   // borders
  fainter:    "#EDE6E0",   // subtle borders
  heartGlow:  "rgba(201,132,138,0.18)",
};
...
// ════════════════════════════════════════════════════════════════════
//  BOUQUET MODAL  — updated: image instead of flower emoji map
// ════════════════════════════════════════════════════════════════════
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img
            src="/assets/realistic-bouquet.png"
            alt="Bouquet"
            style={{
              width: "100%",
              maxHeight: "320px",
          ...
          <p style={{
            ...
            A beautiful bouquet, crafted just for you.
          </p>
        </motion.div>
  ...
  return (
    ...
    >
      ...
      <motion.svg
        ...
        animate={{ scale: [1, 1.18, 1, 1.18, 1], opacity: [0.06, 0.11, 0.06, 0.11, 0.06] }}
        transition={{
          duration: 1.6,
          repeat: Infinity,
          ease: "easeInOut",
...
export default function BirthdayTributeV2() {
  ...
  // ── Cake state ───────────────────────────────────────────────
  const [blowStep, setBlowStep]             = useState(0);   // 0=unlit, 1=flickering, 2=blown
  ...
  // ── Cake blow handler ────────────────────────────────────────
  const handleCakeBlow = useCallback(() => {
    if (blowStep === 0) {
      setBlowStep(1);
    } else if (blowStep === 1) {
      setBlowStep(2);
      setTimeout(() => setCakeSliced(true), 900);
          ...
          {showMain && (
            ...
            >
              ...
              <section style={{
                ...
                <div aria-hidden="true" style={{
                  position: "absolute", inset: 0,
                  background: "radial-gradient(ellipse at 50% 60%, rgba(232,201,154,0.07) 0%, transparent 68%)",
                  pointerEvents: "none",
                }} />

                <div style={{ textAlign: "center", position: "relative", zIndex: 1, maxWidth: 560 }}>
                  <Reveal>
                    <SectionLabel index={5} text="Make a Wish" />
                    <PetalRule style={{ marginBottom: 48 }} />
                  </Reveal>
                    ...
                    <div style={{ display: "flex", justifyContent: "center", marginBottom: 8 }}>
                      <style>{`
                        @keyframes flicker {
                          ...
                          25%     { transform: scaleY(1.12) rotate(2deg); opacity: 0.9; }
                          50%     { transform: scaleY(0.9) rotate(-1deg); opacity: 0.85; }
                          75%     { transform: scaleY(1.08) rotate(1deg); opacity: 0.95; }
                        }
                        @keyframes flickerFast {
                          0%,100% { transform: scaleY(1) rotate(-4deg); opacity: 0.9; }
                          20%     { transform: scaleY(0.7) rotate(5deg);  opacity: 0.5; }
                          40%     { transform: scaleY(1.1) rotate(-3deg); opacity: 0.8; }
                          60%     { transform: scaleY(0.5) rotate(4deg);  opacity: 0.3; }
                          80%     { transform: scaleY(0.9) rotate(-2deg); opacity: 0.6; }
                        }
                      `}</style>
                      <div style={{
                        width: 22,
                        height: blowStep === 2 ? 0 : 44,
                        borderRadius: "50% 50% 20% 20%",
                        background: blowStep === 2
                          ? "transparent"
                          : `radial-gradient(ellipse at 50% 80%, ${C.champagne} 0%, ${C.roseGold} 55%, ${C.roseDark} 100%)`,
                        boxShadow: blowStep === 2
                          ? "none"
                          : `0 0 18px 6px rgba(232,201,154,0.45), 0 0 40px 10px rgba(201,132,138,0.20)`,
                        transformOrigin: "bottom center",
                        animation: blowStep === 0
                          ? "flicker 1.8s ease-in-out infinite"
                          : blowStep === 1
                          ? "flickerFast 0.35s ease-in-out infinite"
                          : "none",
                  ...
                  <Reveal delay={0.3}>
                    <img
                      ...
                      style={{
                        ...
                        margin: "0 auto 36px",
                        filter: cakeSliced
                          ? "drop-shadow(0 0 18px rgba(201,132,138,0.5))"
                          : "drop-shadow(0 0 8px rgba(232,201,154,0.25))",
                  ...
                  <Reveal delay={0.4}>
                    <p style={{
                      ...
                      {blowStep === 0 && "Close your eyes. Make a wish. Then blow…"}
                      {blowStep === 1 && "One more time — blow it all out! 🌬️"}
                      {blowStep === 2 && cakeSliced && `Happy Birthday, ${CONFIG.name}. ✨ Your wish is out in the universe.`}
                    </p>
                  </Reveal>
                  ...
                  {blowStep < 2 && (
                    <Reveal delay={0.5}>
                      <motion.button
                        whileHover={{ scale: 1.04, borderColor: C.roseGold, background: "rgba(201,132,138,0.08)" }}
                        whileTap={{ scale: 0.96 }}
                      ...
                      >
                        <Sparkles size={13} />
                        {blowStep === 0 ? "BLOW THE CANDLE" : "BLOW AGAIN"}
                      </motion.button>
                    </Reveal>
                  )}
                </div>
              ...
              {/* ──────────────────────────────────────────────────
                  §6 — THE EPHEMERAL WISH (with Heartbeat)
              ─────────────────────────────────────────────────── */}
              <section style={{
                minHeight: "92vh",
                display: "flex",
