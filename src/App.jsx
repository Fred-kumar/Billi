...
const HINGLISH_TEXT =
  "Aur is poore universe mein, hua wo sabse bada moment... Jab tum aayi.";
...
// ════════════════════════════════════════════════════════════════════
//  BOUQUET VISUAL — Real tied bunch with stems, leaves & ribbon
// ════════════════════════════════════════════════════════════════════
function BouquetVisual({ selectedFlowers }) {
  // positions for up to 6 flowers in a natural arc
  const positions = [
    { x: 140, y: 60,  rotate: -18 },
    { x: 200, y: 40,  rotate: -6  },
    { x: 260, y: 40,  rotate: 6   },
    { x: 320, y: 60,  rotate: 18  },
    { x: 170, y: 90,  rotate: -10 },
    { x: 290, y: 90,  rotate: 10  },
  ];
  const flowers = selectedFlowers.slice(0, 6);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {flowers.map((fl, i) => {
          const pos = positions[i];
          const midX = (pos.x + 230) / 2;
          const midY = (pos.y + 28 + 240) / 2;
          ...
          return (
            <ellipse
              ...
              fill="#3D7040"
              opacity="0.78"
              transform={`rotate(${pos.rotate * 1.5 + side * 30}, ${midX + side * 14}, ${midY - 8})`}
            />
          );
        })}

        {/* ── Extra accent leaves near tie ── */}
        <ellipse cx={205} cy={215} rx={16} ry={7} fill="#4A7C4E" opacity="0.7" transform="rotate(-35,205,215)" />
        <ellipse cx={255} cy={215} rx={16} ry={7} fill="#4A7C4E" opacity="0.7" transform="rotate(35,255,215)" />
        <ellipse cx={220} cy={228} rx={12} ry={5} fill="#3D7040" opacity="0.6" transform="rotate(-20,220,228)" />
        <ellipse cx={240} cy={228} rx={12} ry={5} fill="#3D7040" opacity="0.6" transform="rotate(20,240,228)" />

        {/* ── Ribbon wrap ── */}
        <path
          d="M200 238 Q230 228 260 238 Q255 252 230 258 Q205 252 200 238Z"
          fill={C.roseGold}
          opacity="0.85"
        />
        {/* Ribbon tails */}
        <path d="M205 250 Q188 272 195 290" stroke={C.roseGold} strokeWidth="6" strokeLinecap="round" fill="none" opacity="0.7"/>
        <path d="M255 250 Q272 272 265 290" stroke={C.roseGold} strokeWidth="6" strokeLinecap="round" fill="none" opacity="0.7"/>
        {/* Ribbon bow knot */}
        <ellipse cx={230} cy={242} rx={8} ry={5} fill={C.roseLight} opacity="0.9"/>
        ...
        {flowers.map((fl, i) => {
          ...
          return (
            <motion.g
              ...
              transition={{ delay: 0.5 + i * 0.14, duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
            ...
            >
              ...
              <circle
                ...
                opacity="0.45"
              />
              {/* Emoji as foreignObject */}
              <foreignObject
                x={pos.x - 24} y={pos.y - 28}
                width={48} height={48}
              >
                <div xmlns="http://www.w3.org/1999/xhtml"
                  style={{
                    ...
                    textAlign: "center",
                    lineHeight: "48px",
                    filter: `drop-shadow(0 0 8px ${fl.glowColor})`,
                    transform: `rotate(${pos.rotate * 0.4}deg)`,
                  }}
                >
                  {fl.emoji}
                </div>
        ...
        {/* ── Bottom handle wrap lines ── */}
        <line x1={226} y1={258} x2={226} y2={310} stroke="#C9848A" strokeWidth="2" opacity="0.3"/>
        <line x1={234} y1={258} x2={234} y2={310} stroke="#C9848A" strokeWidth="2" opacity="0.3"/>
      </svg>
    </motion.div>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Real Tied Bouquet Visual */}
        <BouquetVisual selectedFlowers={selectedFlowers} />
  ...
  return (
    <section style={{
      ...
      <div aria-hidden="true" style={{
        ...
        background: "radial-gradient(ellipse at 50% 50%, rgba(201,132,138,0.05) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
      ...
      <Reveal>
        <div style={{ textAlign: "center", position: "relative", zIndex: 1, maxWidth: 560 }}>
          ...
          <SectionLabel index={6} text="A Little Something" />
          ...
          <p style={{
            ...
            {scratched ? "SURPRISE REVEALED ✦" : "TAP THE CARD TO OPEN"}
          </p>

          {/* Gift Card */}
          <motion.div
            onClick={handleScratch}
            whileHover={!scratched ? { scale: 1.03, y: -4 } : {}}
            whileTap={!scratched ? { scale: 0.97 } : {}}
            style={{
              ...
              overflow: "hidden",
              boxShadow: scratched
                ? `0 0 60px rgba(201,132,138,0.25), 0 0 120px rgba(201,132,138,0.08)`
          ...
          >
            ...
            <div style={{
              position: "absolute", inset: 0,
              background: `linear-gradient(135deg, #1A0810 0%, #0D0508 40%, #180C12 100%)`,
              ...
              {["top: 10px; left: 10px", "top: 10px; right: 10px", "bottom: 10px; left: 10px", "bottom: 10px; right: 10px"].map((pos, i) => (
                <div key={i} aria-hidden="true" style={{
                  ...
                  width: 12, height: 12,
                  borderTop: i < 2 ? `1px solid ${C.roseGold}55` : "none",
                  borderBottom: i >= 2 ? `1px solid ${C.roseGold}55` : "none",
                  borderLeft: i % 2 === 0 ? `1px solid ${C.roseGold}55` : "none",
                  borderRight: i % 2 === 1 ? `1px solid ${C.roseGold}55` : "none",
                }} />
              ))}
            </div>
              ...
              {!scratched && (
                <motion.div
                  ...
                  style={{
                    ...
                    background: `linear-gradient(135deg, ${C.roseGold}22 0%, #C9848A11 50%, ${C.champagne}18 100%)`,
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
                    justifyContent: "center",
                ...
                >
                  <motion.div
                    animate={isRevealing ? { rotate: 360, scale: 0 } : { rotate: [0, 6, -6, 0], scale: [1, 1.08, 1] }}
            ...
            {[25, 50, 75].map((pct, i) => (
              <div key={i} aria-hidden="true" style={{
                ...
                top: 0, bottom: 0,
                width: 1,
                background: `linear-gradient(180deg, transparent, ${C.roseGold}18, transparent)`,
                opacity: 0.4,
              }} />
            ))}
          </motion.div>
        ...
        <AnimatePresence>
          {showMain && (
            ...
            >
                    ...
                    {selectedIds.size > 0 && (
                      ...
                      >
                        <motion.button
                          ...
                          whileTap={{ scale: 0.97 }}
                          onClick={() => { setBouquetOpen(true); setMotionVideoOpen(true); }}
                          style={{
              ...
              {/* ──────────────────────────────────────────────────
                  §5 — MEMORIES IN FRAMES (Photo Gallery)
              ─────────────────────────────────────────────────── */}
              <section style={{
                ...
                <div aria-hidden="true" style={{
                  position: "absolute", inset: 0,
                  background: "radial-gradient(ellipse at 50% 50%, rgba(201,132,138,0.04) 0%, transparent 70%)",
                  pointerEvents: "none",
                }}/>
                ...
                <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
                  <Reveal>
                    <div style={{ textAlign: "center", marginBottom: 60 }}>
                      <SectionLabel index={5} text="Memories in Frames" />
                      <h2 style={{
                        fontFamily: "Cormorant Garamond, Georgia, serif",
                  ...
                  <div style={{
                    ...
                    {[
                      { src: "/image1.jpg", label: "Always Smiling ✦" },
                      { src: "/image2.jpg", label: "Her World 🌸"     },
                      { src: "/image3.jpg", label: "Pure Joy 🌟"      },
                      { src: "/image4.jpg", label: "Forever Her 💫"   },
                    ].map(({ src, label }, i) => (
                      <Reveal key={src} delay={i * 0.15}>
                        ...
                        >
                          ...
                          <div style={{
                            ...
                            top: 10, right: 10,
                            width: 10, height: 10,
                            borderTop: `1px solid ${C.roseGold}66`,
                            borderRight: `1px solid ${C.roseGold}66`,
                          }}/>
                          <div style={{
                            position: "absolute",
                            bottom: 10, left: 10,
                            width: 10, height: 10,
                            borderBottom: `1px solid ${C.roseGold}66`,
                            borderLeft: `1px solid ${C.roseGold}66`,
                          }}/>
                        </motion.div>
                      </Reveal>
                    ))}
                  ...
                  <Reveal delay={0.5}>
                    <div style={{ textAlign: "center", marginTop: 44 }}>
                      ...
                      <p style={{
                        ...
                        Every photo a universe. Every smile, a whole story.
                      </p>
                    </div>
                  </Reveal>
                </div>
              ...
              {/* ──────────────────────────────────────────────────
                  §6 — GIFT CARD SURPRISE
              ─────────────────────────────────────────────────── */}
              <GiftCardSection />

              {/* ──────────────────────────────────────────────────
                  §7 — THE EPHEMERAL WISH (with Heartbeat)
              ─────────────────────────────────────────────────── */}
              <section style={{
                minHeight: "92vh",
                display: "flex",
              ...
              <footer style={{
                ...
                padding: "48px clamp(24px, 6vw, 100px) 36px",
                display: "flex",
                flexDirection: "column",
                alignItems: "center",
                gap: 28,
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 16, width: "100%", maxWidth: 480 }}>
                  <div style={{ flex: 1, height: 1, background: `linear-gradient(90deg, transparent, ${C.faint})` }} />
                  <span style={{ fontSize: 12, color: C.roseGold, opacity: 0.5 }}>✦</span>
                  <div style={{ flex: 1, height: 1, background: `linear-gradient(90deg, ${C.faint}, transparent)` }} />
                </div>
                ...
                <div style={{
                  ...
                  <p style={{
                    ...
                    Made with love · Unauthorized copying is a crime against feelings 💔
                  </p>
                </div>
              </footer>
      ...
      <AnimatePresence>
        {motionVideoOpen && (
          <motion.div
            ...
            onClick={() => setMotionVideoOpen(false)}
            style={{
              position: "fixed",
              inset: 0,
              zIndex: 700,
          ...
          >
            <motion.div
              ...
              style={{
                ...
                position: "relative",
                border: `1px solid ${C.roseGold}44`,
              }}
            >
              <video
                src="/bouquet.mp4"
